...
/** Agregar un campo al todos los documento de una coleccion */
...
db.articulo.find({_id: ObjectId("5db218e90b946bda7f0ddac7")}).pretty();
...
/** Crear un índice sobre una colección */
...
db.venta.find( { detalles:{numDetalle : 1, cantidad : 4, cve_articulo : "DR-57", descripcion : "Amortiguador Ford Mustang 95-96", precio : 945.34} }).pretty();
...
/** Agregar un campo "status" a todos los elementos del arreglo detalles de la venta 1 */
...
db.venta.find().forEach( function(vta){ print ("num_venta: " + vta.num_venta + ", fecha:" + vta.fecha_venta);});
...
/** sin [0] : Es undefined!! po*/
db.venta.aggregate([
	{ $lookup: {from:"persona", localField:"cte_ObjId", foreignField:"_id", as:"cliente"}},
	{ $lookup: {from:"persona", localField:"vendedor_ObjId", foreignField:"_id", as:"vendedor"}},
	{ $project: {_id:false, cte_ObjId:false, detalles:false, vendedor_ObjId:false}}
]).map(function(vta){
	     return {numvta: vta.num_venta, fecha: vta.fecha_venta, vendedor:vta.vendedor.nombre, 
	    	     cliente: vta.cliente.nombre } 
       });
